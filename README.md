...
Single python file, [download](https://github.com/Sonaton11/tpconf-bin-xml/main/tpconf_bin_xml.py?token=GHSAT0AAAAAAB3FAE6JENLVM2JYN7TVWAD2Y4AR2GQ), optionally chmod +x, and  run.
